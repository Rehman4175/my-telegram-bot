...
async def callback_handler(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if d == "menu":
        ...
        # Button se diary open — password maango inline
        ctx.user_data["diary_view"] = ("today", None)
        ctx.user_data["diary_from_callback"] = True
        await message.edit_text(
            "🔐 *Diary — Password Enter Karo:*\n\n"
            "_Tumhari diary private hai. Neeche type karo:_",
            parse_mode="Markdown"
        )
...
async def handle_message(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # 🔐 Diary password check — button se aya tha
